/*
============================================================================
FILE : sevillaCh_LE1_1ChangeDenominationGUI.java
...
public class sevillaCh_LE1_1ChangeDenominationGUI {
	...
	public static void main(String[] args) {
        ...
        changeDenomination.readInputGUI();
        changeDenomination.calculateChange();
        changeDenomination.writeOutputGUI();
	}
}
